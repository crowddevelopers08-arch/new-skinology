...
export default function LeadsTable({ 
  ...
  const getFormBadge = (formName: string) => {
    ...
    const formConfig: { [key: string]: { label: string, color: string } } = {
      'skintreatment': { label: "Skin Treatment", color: "bg-orange-100 text-orange-800 border-orange-200" },
  ...
  const exportToCSV = () => {
    const headers = ["Name", "Phone", "Email", "Hair Concern", "Preferred Date", "Consent", "Form Name", "Source", "TeleCRM Synced", "Created At"]
    ...
    a.href = url
    a.download = `skin-leads-${new Date().toISOString().split('T')[0]}.csv`
    a.click()
      ...
      <Card className="w-full bg-white border-gray-200">
        <CardHeader className="border-b border-gray-200">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              <CardTitle className="text-2xl font-bold text-gray-900">Skin Leads Management</CardTitle>
              <CardDescription className="text-gray-600">
                Manage and track all skin consultation requests from popup forms
        ...
        <CardContent className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-6 gap-4 mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
            <div className="md:col-span-2">
              <div className="relative">
                ...
                <Input
                  placeholder="Search by name, phone, email, concern..."
                  value={searchTerm}
            ...
            <Select value={concernFilter} onValueChange={setConcernFilter}>
              <SelectTrigger className="bg-white border-gray-300 text-gray-900">
                <SelectValue placeholder="Hair Concern" />
              </SelectTrigger>
              <SelectContent className="bg-white border-gray-300 text-gray-900">
                <SelectItem value="all" className="focus:bg-gray-100">All Concerns</SelectItem>
                <SelectItem value="Hair loss" className="focus:bg-gray-100">Hair loss</SelectItem>
                <SelectItem value="Baldness" className="focus:bg-gray-100">Baldness</SelectItem>
                <SelectItem value="Hair thinning" className="focus:bg-gray-100">Hair thinning</SelectItem>
                <SelectItem value="Receding hairline" className="focus:bg-gray-100">Receding hairline</SelectItem>
                <SelectItem value="Other" className="focus:bg-gray-100">Other</SelectItem>
              </SelectContent>
            </Select>
              ...
              <table className="w-full caption-bottom text-sm">
                <thead className="bg-gray-50 border-b border-gray-200">
                  <tr>
                    ...
                    <th className="h-12 px-4 text-left align-middle font-medium text-gray-700">Hair Concern</th>
                    <th className="h-12 px-4 text-left align-middle font-medium text-gray-700">Preferred Date</th>
                ...
                <tbody>
                  {loading ? (
                    ...
                    <tr>
                      <td colSpan={9} className="p-8 text-center text-gray-500">
                        No skin leads found matching your criteria
                      </td>
                    </tr>
                  ) : (
                    filteredLeads.map((lead) => {
                      const formattedDate = formatDate(lead.createdAt)
                      const formattedPrefDate = lead.preferredDate ? formatDate(lead.preferredDate).date : 'Not specified'
                      ...
                      return (
                        <Fragment key={lead.id}>
                          ...
                          >
                            ...
                            <td className="p-4 align-middle">
                              <span className="text-sm font-medium text-gray-900">{lead.concern || lead.treatment || "Not specified"}</span>
                            </td>
                            <td className="p-4 align-middle">
                              <span className="text-sm text-gray-700">{formattedPrefDate}</span>
                            </td>
                            <td className="p-4 align-middle">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                  <div>
                                    ...
                                    <div className="space-y-2 text-gray-700">
                                      ...
                                      {lead.preferredDate && (
                                        <div><span className="font-medium">Preferred Date:</span> {formattedPrefDate}</div>
                                      )}
                                    </div>
                                  </div>
                                  <div>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mt-4 text-sm text-gray-600 gap-2">
            <div>
              Showing {filteredLeads.length} of {leads.length} skin leads
